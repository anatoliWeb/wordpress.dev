...
class WC_Tests_CRUD_Orders extends WC_Unit_Test_Case {
	...
	function test_get_type() {
		$object = new WC_Order();
		$this->assertEquals( 'simple', $object->order_type );
	}
...
//	}
	...
	function test_get_id() {
		$object = new WC_Checkout();
        $id = $object->create_order();
        $object1   = new WC_Order($id);

		$this->assertEquals( $id, $object1->id );
	}
