...
include_once dirname(__FILE__)."/../../includes/data-stores/class-wc-data-store-wp.php";
include_once dirname(__FILE__)."/../../includes/data-stores/interfaces/wc-object-data-store-interface.php";

/**
 * Class WC_Mock_WC_Data_Store
 */
...
include_once dirname(__FILE__) . "/../../includes/abstracts/abstract-wc-data.php";
